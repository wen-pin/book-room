				...
				<div class="orderGrid_orderBox_roomDate">
					...
					<div class="orderGrid_orderBox_roomDate_head orderBox">
						...
						<div class="orderGrid_orderBox_roomDate_head_content">
							...
							<span>平日（一～四）價格：1600 / 假日（五〜日）價格：1900</span>
						</div>
...
<script>
import BackgroundImage from '../../components/ClassicSingleRoom/backgroundImage/index.vue'
import RoomDate from '../../components/ClassicSingleRoom/roomDate/index.vue'
...
export default {
	...
	methods: {
		getRoomPrice () {
            return (this.bookDay.normalDay * 1600) + (this.bookDay.holiday * 1900)
        },
		closeOrder (){
