				...
				<div class="orderGrid_orderBox_roomDate">
					...
					<div class="orderGrid_orderBox_roomDate_head orderBox">
						...
						<div class="orderGrid_orderBox_roomDate_head_content">
							...
							<span>平日（一～四）價格：3200 / 假日（五〜日）價格：3500</span>
						</div>
...
<script>
import BackgroundImage from '../../components/DeluxeTwinRoom/backgroundImage/index.vue'
import RoomDate from '../../components/DeluxeTwinRoom/roomDate/index.vue'
...
export default {
	...
	methods: {
		getRoomPrice () {
            return (this.bookDay.normalDay * 3200) + (this.bookDay.holiday * 3500)
        },
		closeOrder (){
