				...
				<div class="orderGrid_orderBox_roomDate">
					...
					<div class="orderGrid_orderBox_roomDate_head orderBox">
						...
						<div class="orderGrid_orderBox_roomDate_head_content">
							...
							<span>平日（一～四）價格：2400 / 假日（五〜日）價格：2700</span>
						</div>
...
<script>
import BackgroundImage from '../../components/StandardTwinRoom/backgroundImage/index.vue'
import RoomDate from '../../components/StandardTwinRoom/roomDate/index.vue'
...
export default {
	...
	methods: {
		getRoomPrice () {
            return (this.bookDay.normalDay * 2400) + (this.bookDay.holiday * 2700)
        },
		closeOrder (){
